...
class ExportModelForGCPTest(TestCase):    
    ...
    def test_re_export_model_LaserTagger(self):
        ...
        output = subprocess.check_output(("saved_model_cli show --dir=" + TEMP_TEST_FOLDER_1 + " --all").split())
        ...
        output = subprocess.check_output(("saved_model_cli show --dir=" + TEMP_TEST_FOLDER_2 + " --all").split())
        output = output.decode("utf-8").strip().split("\n")
