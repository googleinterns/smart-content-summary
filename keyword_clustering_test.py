...
class KeywordClusteringTest(TestCase):    
    def test_keyword_clustering_with_nonempty_summary(self):
        ...
        shortened_keywords_list, total_keyword_counts, model_name_list = cluster_keywords(TEMP_TESTING_FILE)
        self.assertEqual(shortened_keywords_list, 
                         [{'cluster1': ['Object1', 'Object2', 'Object3'], 'cluster2': ['Object4']},
    ...
    def test_keyword_clustering_with_empty_summary(self):
        ...
        shortened_keywords_list, total_keyword_counts, model_name_list = cluster_keywords(TEMP_TESTING_FILE)
        self.assertEqual(shortened_keywords_list, 
                         [{'cluster1': ['Object2', 'Object3'], 'cluster2': ['Object4']},
