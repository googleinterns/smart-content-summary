...
class PreprocessUtilsTestCase(TestCase):
    ...
    def test_split_dataset(self):
        ...
        preprocess_utils.split_dataset(train_file_path, tune_file_path, valid_file_path, proprocessed_file_path,
                                       num_of_tuning_sam, num_of_valid_sam, whether_shuffle)
