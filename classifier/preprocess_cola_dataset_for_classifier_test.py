...
import preprocess_MS_dataset_for_classifier

TEMP_COLA_FILE_PATH = "./temp_test_cola_dataset.tsv"
TEMP_MS_FILE_PATH = "./temp_test_grammar_dataset.tsv"
OUTPUT_FILE_PATH = os.path.expanduser("~/classifier_mixed_training_set_grammar.tsv")
OUTPUT_PREPROCESSED_FILE_PATH = os.path.expanduser("~/classifier_preprocessed_cola_dataset.tsv")

class PreprocessCOLADatasetForClassifierTest(TestCase):  
    def _populate_cola_files(self, number_negative_sample, number_positive_sample):
    ...
    def test_preprocess_with_valid_ratio(self):
        ...
        subprocess.run(["python", "preprocess_cola_dataset_for_classifier.py", 
                        ...
                        TEMP_COLA_FILE_PATH, TEMP_MS_FILE_PATH], stdout=DEVNULL, stderr=DEVNULL)
