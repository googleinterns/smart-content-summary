...
def combine_two_tsv_files(original_file_path, append_file_path,
                          number_of_new_lines, output_file_path):
  ...
  if number_of_new_lines > len(new_lines):
    raise ValueError(
        "The target ratio is too big given the number of synthetic data.")
...
def main(args):
  ...
  combine_two_tsv_files(
      original_data_file, synthetic_data_file,
      calculate_number_of_synthetic_data_to_mix(original_data_file,
                                                target_ratio),
...
if __name__ == "__main__":
  ...
  parser.add_argument("synthetic_data_file",
                      help="Absolute path to synthetic dataset.")
  parser.add_argument("original_data",
                      help="Absolute path to the original data.")
  parser.add_argument('target_ratio',
                      type=float,
                      help="The target ratio of negative sample.")
